...
lab = Label(sp, text = 'Internet Speed text', font = ('Time New Roman', 30, 'bold'))
lab.place(x = 58, y = 40, height = 50, width = 380)


lab = Label(sp, text = 'Download Speed', font = ('Time New Roman', 30, 'bold'), )
lab.place(x = 58, y = 130,height = 50, width = '380')

lab_down = Label(sp, text = '00', font = ('Time New Roman', 30, 'bold'), )
lab_down.place(x = 58, y = 200, height = 50, width = 380)

lab = Label(sp, text = 'Upload Speed', font = ('Time New Roman', 30, 'bold'), )
lab.place(x = 58, y = 290, height = 50, width = 380)

lab_up = Label(sp, text = '00', font = ('Time New Roman', 30, 'bold'), )
lab_up.place(x = 58, y = 360, height = 50, width = 380)
